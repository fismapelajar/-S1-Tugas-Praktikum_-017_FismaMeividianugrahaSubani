...
main ()
{
	...
	for(j=0; j<i; j++)
	{
		...
		struk<<"|"<<setw(13)<<belanja[j].nama_b<<setw(3);
		struk<<"|"<<setw(13)<<belanja[j].harga<<setw(2);
		struk<<"|"<<setw(7)<<belanja[j].jumlah<<setw(2);
		struk<<"|"<<setw(14)<<belanja[j].harjum<<setw(3)<<"|"<<endl;
